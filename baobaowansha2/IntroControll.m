...
- (id)initWithFrame:(CGRect)frame pages:(NSArray*)pagesArray
{
    ...
    if(self != nil) {
        ...
        if (YES) {
            ...
            [startButton setTitle:@"即刻开始" forState:UIControlStateNormal];
            ...
            startButton.frame = CGRectMake((self.frame.size.width-160.0)/2, self.frame.size.height-65, 160.0, 30.0);
